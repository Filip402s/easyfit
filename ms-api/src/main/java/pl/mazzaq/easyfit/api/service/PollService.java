package pl.mazzaq.easyfit.api.service;
...
import pl.mazzaq.easyfit.api.exception.BadRequestException;
import pl.mazzaq.easyfit.api.exception.ResourceNotFoundException;
import pl.mazzaq.easyfit.api.model.Choice;
import pl.mazzaq.easyfit.api.model.ChoiceVoteCount;
import pl.mazzaq.easyfit.api.model.Poll;
import pl.mazzaq.easyfit.api.model.User;
import pl.mazzaq.easyfit.api.model.Vote;
...
import pl.mazzaq.easyfit.api.util.ModelMapper;
...
public class PollService {
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        return ModelMapper.mapPollToPollResponse(poll, choiceVotesMap,
                creator, userVote != null
                        ? userVote.getChoice().getId()
                        : null);
    }
